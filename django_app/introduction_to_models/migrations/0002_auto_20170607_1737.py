# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-07 17:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='person',
            name='shirt_size',
            field=models.CharField(choices=[('S', 'Small'), ('M', 'Medium'), ('L', 'Large')], help_text='사이즈를 선택하세요', max_length=1, verbose_name='셔츠사이즈'),
        ),
        migrations.AddField(
            model_name='car',
            name='manufacturer',
